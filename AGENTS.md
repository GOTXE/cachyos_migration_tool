...
- `docs/` — toda la documentación en Markdown organizada por subsistema. Sin scripts ni binarios.
  - Todo archivo nuevo en `docs/` debe colocarse en el subdirectorio que corresponda a su subsistema (`hardware/`, `mbp-watch/`, `extensions/`, etc.), con nombre en kebab-case.
  - Tras añadir cualquier archivo en `docs/`, actualiza `docs/README.md` añadiendo una entrada en la sección correspondiente.
