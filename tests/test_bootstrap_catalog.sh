...
assert_contains "$CATALOG_2015" "appimage|Soporte AppImages (fuse2 + webkit2gtk-4.1)|OFF" "catalog 12,1 appimage"
...
assert_contains "$CATALOG_2015" "libreoffice|LibreOffice Fresh ES + Java 21|OFF" "catalog 12,1 libreoffice"
...
assert_contains "$CATALOG_GENERIC" "appimage|Soporte AppImages (fuse2 + webkit2gtk-4.1)|OFF" "catalog generic appimage"
...
assert_contains "$CATALOG_GENERIC" "libreoffice|LibreOffice Fresh ES + Java 21|OFF" "catalog generic libreoffice"
